    ...
    def main(self):
        ...
        for repo_domain in domain_dir:
            ...
            for project in projects:
                ...
                print("-" * 20)
                projectname = project
                directory = str(self.src_dir) + '/' + str(repo_domain) + '/' + str(project)
                ...
                for root, dirs, files in os.walk(directory):
                    ...
                    for basename in files:
                        if fnmatch.fnmatch(basename, file_ext_pattern):
                            ...
                            des_dir_file = str(self.des_dir) + repo_domain + '/' + str(projectname) + str(
                                current_dir[1])

                            if os.path.isfile(filename_in):
                                # print(filename_in)
                                file_count = file_count + 1
                                self.preprocess(filename_in, des_dir_file, projectname, file_type="")
